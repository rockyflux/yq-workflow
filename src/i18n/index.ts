...
const zhCN = {
  ...
  init: {
    ...
    api: {
      ...
      skipNoticeTitle: 'API 配置已跳过，YQ 不会修改 settings.json 中的 ANTHROPIC_*',
      urlPrompt: 'API URL',
      urlRequired: '必填',
      keyPrompt: 'API Key',
      keyRequired: '必填',
...
const en: typeof zhCN = {
  ...
  init: {
    ...
    summary: {
      ...
      frontendModels: 'Legacy field:',
      backendModels: 'Legacy field:',
      collaboration: 'Install mode:',
      workflows: 'Workflows:',
      selected: 'selected',
      apiProvider: 'API Provider',
      modelRouting: 'Legacy field',
      geminiModel: 'Legacy field',
    ...
    api: {
      ...
      skipNoticeTitle: 'API configuration skipped — YQ will not touch ANTHROPIC_* in settings.json',
      urlPrompt: 'API URL',
    ...
    model: {
      title: 'Legacy model configuration',
    ...
    hooks: {
      title: 'Legacy auto-authorization',
      description: 'This capability has been removed',
      installed: 'This capability has been removed',
