...
const zhCN = {
  ...
  cli: {
    help: {
      ...
      optionDescriptions: {
        ...
        frontendModels: '旧参数（已移除）',
        backendModels: '旧参数（已移除）',
        collaborationMode: '旧参数（已移除）',
        workflows: '要安装的工作流',
        installDir: '安装目录',
      },
      ...
      exampleDescriptions: {
        ...
        customModels: '自定义安装参数',
        parallelMode: '使用非交互安装',
      },
    },
  },
  init: {
    ...
    pathWarning: '命令已安装到 Claude Code 目录',
    ...
    mcp: {
      ...
      aceToolRsPaid: '更轻量',
      skipLater: '稍后手动配置',
      skipTokenPrompt: '是否跳过 Token 配置？（可稍后运行 npx yq config mcp 配置）',
      skipKeyPrompt: '是否跳过 API Key 配置？（可稍后运行 npx yq config mcp 配置）',
    ...
    models: {
      codex: 'Codex - 外部辅助工具',
      gemini: 'Gemini - 历史兼容字段',
      claude: 'Claude - 当前核心工作流模型',
    },
    workflows: {
      dev: '完整开发工作流 (/yq:dev)',
      frontend: '前端任务 (/yq:frontend)',
      backend: '后端任务 (/yq:backend)',
      review: '代码审查 (/yq:review)',
      analyze: '技术分析 (/yq:analyze)',
      commit: 'Git 智能提交 (/yq:commit)',
      rollback: 'Git 回滚 (/yq:rollback)',
      cleanBranches: '清理分支 (/yq:clean-branches)',
      worktree: 'Worktree 管理 (/yq:worktree)',
      init: '项目初始化 (/yq:init)',
    },
    aceTool: {
  ...
  update: {
    ...
    willNotUpdateCli: '注意：这不会更新 yq 命令本身',
  ...
  menu: {
    ...
    tools: {
      ...
      codexInstallSuccess: 'Codex 安装成功',
      codexRunHint: '运行 codex 命令启动',
    ...
    checkUpdates: {
      title: '检查工具更新',
      subtitle: '检查并更新 Claude Code、Codex、CCR 和 CCometixLine',
      current: '当前',
      latest: '最新',
      notInstalled: '未安装',
      latestFetchFailed: '查询失败',
      allLatest: '当前已是最新版本，或暂无可更新项目',
      selectTargets: '选择要安装 / 更新的工具',
      updated: '{{name}} 更新完成',
    },
    uninstall: {
      globalDetected: '检测到你是通过 npm 全局安装的',
      ...
      confirm: '确定要卸载 YQ 吗？这将强制移除所有命令目录、配置文件和数据。',
...
const en: typeof zhCN = {
  ...
  cli: {
    help: {
      ...
      optionDescriptions: {
        ...
        frontendModels: 'Legacy option (removed)',
        backendModels: 'Legacy option (removed)',
        collaborationMode: 'Legacy option (removed)',
      ...
      exampleDescriptions: {
        ...
        customModels: 'Custom install parameters',
        parallelMode: 'Use non-interactive install',
      },
    },
  },
  init: {
    ...
    pathWarning: 'Commands are installed into the Claude Code directory',
    ...
    summary: {
      ...
      mcpTool: 'MCP Tool',
      webUI: 'Web UI',
      apiSelfManaged: 'self-managed (YQ does not touch)',
    ...
    mcp: {
      ...
      skipTokenPrompt: 'Skip Token configuration? (run npx yq config mcp later)',
      skipKeyPrompt: 'Skip API Key configuration? (run npx yq config mcp later)',
    ...
    models: {
      codex: 'Codex - External helper tooling',
      gemini: 'Gemini - Legacy compatibility field',
      claude: 'Claude - Primary workflow model',
    },
    workflows: {
      dev: 'Full development workflow (/yq:dev)',
      frontend: 'Frontend tasks (/yq:frontend)',
      backend: 'Backend tasks (/yq:backend)',
      review: 'Code review (/yq:review)',
      analyze: 'Technical analysis (/yq:analyze)',
      commit: 'Git smart commit (/yq:commit)',
      rollback: 'Git rollback (/yq:rollback)',
      cleanBranches: 'Clean branches (/yq:clean-branches)',
      worktree: 'Worktree management (/yq:worktree)',
      init: 'Project initialization (/yq:init)',
    },
    aceTool: {
  ...
  update: {
    ...
    willNotUpdateCli: 'Note: This will not update the yq command itself',
  ...
  menu: {
    ...
    help: {
      title: 'YQ Commands:',
      hint: 'For more information, run: npx yq --help',
      sections: {
      ...
      descriptions: {
        ...
        execute: 'Execute against an existing plan with verification',
        dev: 'Complete 6-phase development workflow',
        frontend: 'Frontend task flow',
        backend: 'Backend task flow',
        feat: 'Smart feature development',
        review: 'Code review and risk identification',
        analyze: 'Technical analysis and architecture review',
        debug: 'Diagnosis + fix',
        optimize: 'Performance optimization',
        test: 'Test generation',
        specInit: 'Initialize OpenSpec environment',
        specResearch: 'Requirements → Constraint set',
        specPlan: 'Generate an implementation plan from the spec',
        specImpl: 'Spec-driven implementation',
        specReview: 'Pre-archive consistency review',
    ...
    tools: {
      ...
      codexInstallSuccess: 'Codex installed successfully',
      codexRunHint: 'Run the codex command to start',
    ...
    checkUpdates: {
      title: 'Check tool updates',
      subtitle: 'Check and update Claude Code, Codex, CCR, and CCometixLine',
      current: 'Current',
      latest: 'Latest',
      notInstalled: 'Not installed',
      latestFetchFailed: 'Lookup failed',
      allLatest: 'Everything is up to date or no upgrades are available',
      selectTargets: 'Select tools to install/update',
    ...
    uninstall: {
      ...
      confirm: 'Are you sure you want to uninstall YQ? This will force remove all command directories, config files and data.',
      ...
      runInNewTerminal: 'Please run in a new terminal window:',
      afterDone: 'After completion, the yq command will be fully removed',
    },
  },
}
