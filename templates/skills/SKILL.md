---
name: yq-skills
description: YQ Skills - Quality gates, documentation generator, and multi-agent orchestration. Auto-installed by YQ workflow system.
license: MIT
...
These skills are automatically installed during `npx yq-workflow` initialization.
To update: run `npx yq-workflow update` or `npx yq-workflow` again.
